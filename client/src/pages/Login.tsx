...
const Login = () => {
	...
	return (
		<section className="flex flex-row justify-center align-middle h-screen w-screen bg-gradient-to-b from-yellow-50 via-white to-primary pt-32 md:pt-48 px-2">
			...
			/>
			<article className="flex flex-col justify-start bg-white align-middle w-full sm:w-9/12 md:w-8/12 lg:w-1/2 max-w-lg h-fit rounded-xl py-8 mb-24 border border-slate-400 shadow-lg shadow-slate-800">
				<div className="ml-6 h-12 w-28 lg:w-40">
