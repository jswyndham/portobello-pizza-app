    ...
    <>
      <motion.article className="relative overflow-hidden w-screen h-full bg-red-700 md:m-auto">
        ...
        <HomeJSONLD
          ...
          address={{
            streetAddress: "Sai Ree Road, Ban Ko Tao, Thailand, Surat Thani",
        ...
        <motion.img
          ...
          className="absolute inset-0 left-12 md:left-20 lg:left-44 xl:left-28 top-2 md:top-8 2xl:top-12 w-3/12 lg:w-2/12 md:max-w-3xl pt-6 z-10"
        />
