...
function PastaMenu() {
	...
	if (menuItems.length === 0) {
		return <ItemNotFound item="pasta menu items" />;
	}
	...
	return (
		<>
			...
			<article className="w-screen h-full bg-main-gradient min-h-screen">
				<Helmet>
					<title>
						Porto Bello Pasta Menu | Italian Food on Koh Tao Island
					</title>
					<meta
						name="description"
						content="Enjoy the best pasta on Koh Tao Island at Porto Bello. Check out our variety of pasta with fresh ingredients."
					/>
					<link
						rel="canonical"
				...
				<article className="h-full pt-12 px-2 xl:pt-24 flex flex-col justify-center items-center">
					<HeadingOne headingOneText={'Pasta Menu'} />
