      ...
      <article className="relative overflow-hidden h-screen flex justify-center align-middle">
        ...
        <div className="absolute inset-0  flex flex-col justify-center text-center items-center px-12">
          <img
            ...
            alt="Main Logo"
            className="absolute inset-0 mx-auto w-64 md:max-w-md mt-16"
          />
          ...
          <Link
            to="/"
            className="text-xl 2xl:text-3xl text-yellow-400 py-10 underline underline-offset-8 hover:cursor-pointer"
          >
            homepage
          </Link>
        </div>
