...
function StarterMenu() {
	...
	return (
		<article className="w-screen h-full bg-main-gradient min-h-screen">
			<Helmet>
				<title>
					Porto Bello Starter Menu | Italian Food on Koh Tao Island
				</title>
				<meta
					name="description"
					content="Enjoy the best Italian starters on Koh Tao Island at Porto Bello, Koh Tao. Check out our variety of starter dishes with fresh ingredients."
				/>
				<link
					rel="canonical"
			...
			<article className="h-full pt-12 px-2 xl:pt-24 flex flex-col justify-center items-center">
				<HeadingOne headingOneText={'Starter Menu'} />
