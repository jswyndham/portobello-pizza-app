...
const SidebarMenu = () => {
  ...
  return (
    <>
      <div className="relative bg-gradient-to-r from-white via-red-800 to-primary flex justify-end">
      ...
      />
      <motion.nav
        className="fixed z-50 top-0 right-0 bottom-0 w-11/12 bg-forth text-white border-l-2 border-third  md:hidden"
        style={{ opacity: 1 }}
        initial="closed"
        animate={isOpen ? "open" : "closed"}
