...
const Navbar = () => {
	return (
		<nav className="hidden md:flex absolute z-20 w-full h-16 bg-forth bg-opacity-70 justify-end py-14 lg:py-10 md:px-6">
			...
			<ul className="w-fit text-white text-sm sm:text-md md:text-lg lg:text-xl font-robotoSlab flex flex-row lg:gap-10 2xl:gap-16 justify-around md:justify-between items-center">
				<Link to="/">
