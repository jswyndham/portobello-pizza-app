  ...
  return (
    <article>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="h-64 w-4/12 lg:max-w-lg mx-2 lg:mx-0 rounded-lg drop-shadow-md shadow-md shadow-slate-400 border-solid border-2 border-third bg-white">
          <div className="modal">
            <div className="flex justify-center m-10">
              <p className="text-2xl font-serif text-center">{message}</p>
            </div>
