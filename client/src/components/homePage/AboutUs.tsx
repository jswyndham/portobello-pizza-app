...
const AboutUs = () => {
  return (
    <article className="h-fit w-full p-1 lg:p-20 2xl:p-32 flex flex-col justify-center items-center bg-gradient-to-b from-white via-red-200 to-primary">
      <div className="h-fit flex flex-col lg:flex-row w-10/12 rounded-xl items-center mx-1 my-4 lg:my-16 lg:mx-6">
      ...
      <div className="flex flex-col lg:flex-row-reverse w-10/12 rounded-xl mx-1 my-4">
        <div className="my-2 lg:my-0">
          <img
            src={pastaPic}
