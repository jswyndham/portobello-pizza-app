	...
	return (
		<article className="h-fit w-full 2xl:w-9/12 p-1 lg:p-14 2xl:px-8 2xl:py-12 flex flex-col justify-center items-center">
			...
			<div className="h-fit flex flex-col lg:flex-row w-full 2xl:w-11/12 3xl:w-8/12 items-center mx-1 my-4 lg:mb-16 lg:mt-8 lg:mx-6 ">
				...
				<div className="flex flex-col w-fit bg-slate-300 bg-opacity-30 lg:bg-opacity-30 border border-slate-400 p-6 lg:p-12 rounded-md shadow-lg shadow-slate-400">
			...
			<div className="flex flex-col md:flex-row-reverse w-full 2xl:w-11/12 3xl:w-8/12 rounded-xl mx-1 my-4">
				...
				<div className="flex flex-col w-fit mb-8 bg-slate-300 bg-opacity-30 p-6 lg:p-12 border border-slate-400 rounded-md shadow-lg shadow-slate-500">
					<h3 className="text-3xl lg:text-4xl font-cinzel ml-4 lg:ml-12 py-3 lg:py-6">
