...
const AboutUs = () => {
  return (
    <article className="h-fit w-full p-1 lg:p-20 2xl:px-32 2xl:py-12 flex flex-col justify-center items-center bg-gradient-to-b from-white via-red-200 to-primary">
